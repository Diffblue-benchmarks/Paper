...
class V29_LogIPsDiffblueTest {
  /**
   * Test {@link V29_LogIPs#apply(VersionedBuilder)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link V29_LogIPs#apply(VersionedBuilder)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void V29_LogIPs.apply(VersionedBuilder)"})
