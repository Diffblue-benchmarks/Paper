...
class V29_ZeroWorldHeightDiffblueTest {
  /**
   * Test {@link V29_ZeroWorldHeight#apply(VersionedBuilder)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link V29_ZeroWorldHeight#apply(VersionedBuilder)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void V29_ZeroWorldHeight.apply(VersionedBuilder)"})
  void testApply_givenVersionedBuilder_thenCallsAddVersion() {
    ...
    // Act
    V29_ZeroWorldHeight.apply(builder);

    // Assert
    verify(builder).addVersion(eq(29), isA(ConfigurationTransformation.class));
  }
}
