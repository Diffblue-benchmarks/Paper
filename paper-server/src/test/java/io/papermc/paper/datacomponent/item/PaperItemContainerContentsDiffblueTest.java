...
import io.papermc.paper.datacomponent.item.ItemContainerContents.Builder;
import io.papermc.paper.datacomponent.item.PaperItemContainerContents.BuilderImpl;
...
class PaperItemContainerContentsDiffblueTest {
  /**
