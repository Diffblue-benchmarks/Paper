...
import io.papermc.paper.datacomponent.item.BundleContents.Builder;
import io.papermc.paper.datacomponent.item.PaperBundleContents.BuilderImpl;
...
class PaperBundleContentsDiffblueTest {
  /**
